...
const artworks: Artwork[] = [
  ...
  },
  {
    ...
    slug: 'la-promesa',
    imageUrl: 'la-promesa.jpg',
    dataAiHint: '',
    materials: ['Fieltro', 'Poliuretano', 'Hierro'],
    dimensions: '120cm x 100cm x 40cm',
    year: 2024,
  ...
  },
  {
    ...
    title: 'Colapso',
    slug: 'colapso',
    imageUrl: 'colapso.jpg',
    dataAiHint: '',
    materials: ['Fieltro', 'Barro', 'Hierro'],
  ...
  },
  {
    ...
    title: 'Esteparia',
    slug: 'esteparia',
    imageUrl: 'esteparia.png',
    dataAiHint: 'ocean fabric',
    materials: ['Fieltro', 'Tela'],
    dimensions: '70cm x 120cm',
    year: 2022,
